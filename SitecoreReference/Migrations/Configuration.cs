namespace SitecoreReference.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<SitecoreReference.Dal.SqlRepository>
    {
        ...
        protected override void Seed(SitecoreReference.Dal.SqlRepository context)
        {
            context.ClientComments.AddOrUpdate(
              c => c.Id,
              new ClientComment
              {
                  Id = 1,
            ...
            context.RecentWorks.AddOrUpdate(r => r.Id,
                new RecentWork
                {
                    Id = 1,
            ...
            context.TeamMemberProfiles.AddOrUpdate(t => t.Id,
